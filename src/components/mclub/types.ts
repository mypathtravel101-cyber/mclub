export type UserRole = 'iBanker_STAFF' | 'SME_OWNER' | 'DIRECTOR' | 'END_USER';
...
export const iBanker_NAV: NavItem[] = [
...
export function getNavForRole(role: UserRole): NavItem[] {
  switch (role) {
    case 'iBanker_STAFF': return iBanker_NAV;
    case 'SME_OWNER': return SME_NAV;
    case 'DIRECTOR': return DIRECTOR_NAV;
